...
const PositiveImpactsModalContent: FC = () => (
  <div className={STYLES_WRAPPER}>
    ...
    <Section>
      ...
      <p>
        Land-based, cost-effective (available up to $100/tCO2), carbon reduction potentials for
        Rwanda were sourced from Roe et al. (2021) for the 15 measures listed in Table 1.
      </p>
      <p>
        <i>
