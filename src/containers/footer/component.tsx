  ...
  return (
    <footer className="fixed bottom-0 left-0 w-full">
      <div className="m-auto flex justify-center space-x-8 p-2 font-inter text-xs tracking-wide text-white">
        <div className="flex items-center justify-center space-x-5 py-0">
          <div>
            <button
              type="button"
              onClick={() => setModalVisibility(!isModalOpen)}
              className="m-auto flex justify-end space-x-8 p-2 font-inter text-xs tracking-wide text-white"
            >
              About
            </button>
